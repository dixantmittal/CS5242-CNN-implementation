...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        if settings.time_analysis['logger_enabled'] and settings.time_analysis['logger_level'] >= 2:
            print(colored('>>>>>>>TIME ANALYSIS<<<<<<<<<', 'red'))
            print('conv_relu_pool forward:  [', fc_start_time - conv_start_time, ']')
            print('fc_relu forward:         [', softmax_start_time - fc_start_time, ']')
            print('fc_softmax forward:      [', softmax_end_time - softmax_start_time, ']')
            print('loss time:               [', affine_backward_time - loss_time, ']')
            print('fc_softmax backward:     [', affine_relu_backward_time - affine_backward_time, ']')
            print('fc_relu backward:        [', conv_relu_pool_backward_time - affine_relu_backward_time, ']')
            print('conv_relu_pool backward: [', complete_time - conv_relu_pool_backward_time, ']')
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
