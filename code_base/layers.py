...
def conv_forward(x, w, b, conv_param):
    ...
    if settings.time_analysis['logger_enabled'] and settings.time_analysis['logger_level'] >= 3:
        print(colored('>>>>>>>TIME ANALYSIS<<<<<<<<<', 'red'))
        print('conv_forward:            [', completion_time - t, ']')
        print(colored('>>>>>>>>>>>>><><<<<<<<<<<<<<<', 'red'))
    ###########################################################################
    #                             END OF YOUR CODE                            #
    ###########################################################################
...
def conv_backward(dout, cache):
    ...
    if settings.time_analysis['logger_enabled'] and settings.time_analysis['logger_level'] >= 3:
        print(colored('>>>>>>>TIME ANALYSIS<<<<<<<<<', 'red'))
        print('conv_backward:           [', completion_time - start_time, ']')
        print(colored('>>>>>>>>>>>>><><<<<<<<<<<<<<<', 'red'))
    ###########################################################################
    #                             END OF YOUR CODE                            #
    ###########################################################################
...
def max_pool_forward(x, pool_param):
    ...
    # implementation using im2col but when filters increases, its performance is very slow
    # x_col = im2col_indices_different_images(x, pool_height, pool_width, 0, stride)
    # im2cool_time = datetime.datetime.now()
    # x_col = x_col.reshape(N, C, pool_height * pool_width, -1)
    # res_time = datetime.datetime.now()
    # x_col = np.max(x_col, axis=2).reshape(N, C, _H, _W)
    ...
    if settings.time_analysis['logger_enabled'] and settings.time_analysis['logger_level'] >= 3:
        print(colored('>>>>>>>TIME ANALYSIS<<<<<<<<<', 'red'))
        print('max_pool_forward:        [', completion_time - start_time, ']')
        print(colored('>>>>>>>>>>>>><><<<<<<<<<<<<<<', 'red'))
    ###########################################################################
    #                             END OF YOUR CODE                            #
    ###########################################################################
...
def max_pool_backward(dout, cache):
    ...
    if settings.time_analysis['logger_enabled'] and settings.time_analysis['logger_level'] >= 3:
        print(colored('>>>>>>>TIME ANALYSIS<<<<<<<<<', 'red'))
        print('max_pool_backward:       [', completion_time - start_time, ']')
        print(colored('>>>>>>>>>>>>><><<<<<<<<<<<<<<', 'red'))
    ###########################################################################
    #                             END OF YOUR CODE                            #
    ###########################################################################
